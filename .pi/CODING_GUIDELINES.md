...
**ALL workflow testing, integration testing, and end-to-end testing goes in `model_tests/`. No exceptions.**

| Suite | Location | Command |
|---|---|---|
| ceniac unit tests only | `tests/` | `uv run pytest tests/` |
| model subpackage + all workflow tests | `model_tests/` | `uv run pytest model_tests/` |
| end-to-end | `model_tests/end_to_end_workflows/` | `uv run pytest model_tests/end_to_end_workflows/ -s` |
